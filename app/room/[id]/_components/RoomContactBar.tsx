      ...
      <div className="flex gap-2 max-w-lg mx-auto">
        {studio.naver_place_url && (
          <motion.a
            ...
            className="flex-1 py-3 bg-[#00D26A] rounded-[14px] border-[2px] border-[#0A0A0A] text-[#0A0A0A] text-[13px] font-bold text-center"
        ...
        {studio.kakao_channel && (
          <motion.a
            ...
            whileTap={{ scale: 0.95, y: 1 }}
            className="flex-1 py-3 bg-[#FFD600] rounded-[14px] border-[2px] border-[#0A0A0A] text-[#0A0A0A] text-[13px] font-bold text-center"
            style={{ boxShadow: '3px 3px 0 #0A0A0A', fontFamily: 'Pretendard, sans-serif' }}
          >
            💬 카카오 문의
          </motion.a>
        ...
        {studio.phone && (
          <motion.a
            ...
            whileTap={{ scale: 0.95, y: 1 }}
            className="flex-1 py-3 bg-[#FF3D77] rounded-[14px] border-[2px] border-[#0A0A0A] text-white text-[13px] font-bold text-center"
            style={{ boxShadow: '3px 3px 0 #0A0A0A', fontFamily: 'Pretendard, sans-serif' }}
          >
            📞 전화
          </motion.a>
