...
| Stage 2 | 밴드 활성화 | 밴드 매칭 + 합주실 락인 + 일본 비즈니스 진출 | MAU KR 5,000+ (3개월 유지), K-factor 1.2+ (2개월), MS 결성 밴드 30+, 합주실 수익 운영비 50%+ 커버 |
...
### 일본 진출 절대 원칙
- 웹 기능(i18n·JA 로케일·공유 채널)은 선행 개발 허용. 2026-10까지 웹개발 집중.
- 비즈니스 진출(공식 투자·현지 운영·계약·결제)은 2026-10 이후.
...
- 고인물 권력 구조 강화 기능
- 일본 비즈니스 진출 (공식 투자·현지 운영·계약·결제 — 2026-10 이후)
